...
//        requestDto.setIsbn("1112223334445556"); // Use a different ISBN
//        BookDto expected = createBookDto();
//        expected.setIsbn("1112223334445556");
//
//        // When
...
//        // When & Then
//        mockMvc.perform(delete("/books/{id}", 1L).contentType(MediaType.APPLICATION_JSON))
